...
export const WORKFLOWS: Workflow[] = [
  {
    ...
    details: {
      ...
      highlights: [
        'Automated AI Lead Scoring & Intent Analysis',
        'Direct integration with Google Sheets database',
        'Instant internal notifications via Email / Slack',
        'Zero CRM migration needed — plug and play'
      ]
    }
  }
];
